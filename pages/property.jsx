    ...
    return (
        <div className='w-full'>
            <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
                ...
                <Image className='abbsolute z-1' layout='fill' objectFit='cover' src="/../public/assets/projects/property.jpg" alt="/" />
            ...
            <div className='max-w-[1240px] p-2 mx-auto grid md:grid-cols-5 gap-8 pt-8'>
                <div className='col-span-4 '>
                    ...
                    <p>
                        ...
                        Users are able to search properties based on an Adress, City, or ZIP code
                        to retrieve a list of active properties currently for sale. You will be able
                        to view property information as well as the specific location of the property
